...
const q = query(collection(db, "posts"), where("topic", "==", "Trending Content"));
...
const createCard = (newCard) => {
    let foodBlog = document.getElementById("trendingBlog");

    if (!trendingBlog) {
        console.error("foodBlog not found");
        return;
    }
    trendingBlog.innerHTML = "";
    ...
    `;
    trendingBlog.appendChild(mainCard);
    });
};
