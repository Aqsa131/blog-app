...
const q = query(collection(db, "posts"), where("topic", "==", "Travel"));
...
const createCard = (newCard) => {
    let foodBlog = document.getElementById("travelBlog");

    if (!travelBlog) {
        console.error("foodBlog not found");
        return;
    }
    travelBlog.innerHTML = "";
    ...
    `;
    travelBlog.appendChild(mainCard);
    });
};
